...
#source("/Users/seansabour/Desktop/School/CST495 Data Science/Homework/class-util.R")  source("/Users/seansabour/Desktop/School/CST495 Data Science/Homework/lin-regr-util.R")
```
...
plot(game_by_game15_16$fg_pct ~ game_by_game15_16$team_id, col=c("firebrick"))
plot(game_by_game15_16$fg3_pct ~ game_by_game15_16$team_id, col=c("firebrick"), las=2)
plot(game_by_game15_16$pf ~ game_by_game15_16$team_id, col=c("firebrick"), las=2)
plot(game_by_game15_16$pts ~ game_by_game15_16$team_id, col=c("firebrick"), las=2)
...
fit = glm(wl ~ fgm + fg3m + fgm_opp + fg3m_opp, data = game_by_game14_15, family = binomial)
summary(fit)

# x = te_data[,c("fgm","fg3m","ftm","blk","stl","reb","ast","tov","pf","fgm_opp","fg3m_opp","ftm_opp","blk_opp","stl_opp","reb_opp","ast_opp","tov_opp","pf_opp")]

head_to_head = function(team1,team2){
  team1="spurs"
  team2="warriors"
  # get both the team's entire season stats
  firstTeam = game_by_game15_16[game_by_game15_16$team_name == team1 | game_by_game15_16$team_name_opp == team1,]
  ...
  #### FIX THIS DOESNT TAKE INTO ACCOUNT FOR AWAY GAMES...
#   if(last_10_games_team1$team_name == team1){
#       last_10_games_team1 = lapply(last_10_games_team1[, c("fgm","fg3m","ftm","blk","stl","reb","ast","tov","pf")], mean, na.rm = TRUE)
#   } else {
#     last_10_games_team1 = lapply(last_10_games_team1[, c("fgm_opp","fg3m_opp","ftm_opp","blk_opp","stl_opp","reb_opp","ast_opp","tov_opp","pf_opp")], mean, na.rm = TRUE)
#   }
  
  
  secondTeam = game_by_game15_16[game_by_game15_16$team_name == team2 | game_by_game15_16$team_name_opp == team2,]
...
#   if(last_10_games_team2$team_name == team1){
#       last_10_games_team2 = lapply(last_10_games_team2[, c("fgm","fg3m","ftm","blk","stl","reb","ast","tov","pf")], mean, na.rm = TRUE)
#   } else {
...
#   }
  ...
  names(y) = c("fgm_opp", "fg3m_opp", "ftm_opp" ,"blk_opp", "stl_opp", "reb_opp", "ast_opp", "tov_opp", "pf_opp")
  x = cbind(x,y)
  # Predicts and rounds the scores
  team1_win_loss = predict(fit, newdata = x, type="response")
  
  ifelse(team1_win_loss > 0.5,'W','L')
  return(team1_win_loss)
}

head_to_head("spurs","warriors")
...
p = predict(fit,newdata = x, type="response")
p[2]
