...
series = function(team1,team2) {
    ...
    for(i in 1:7) {
      ...
      if(i <= 2){
        ...
        ifelse(x == "W",team1_score = team1_score + 1,team2_score = team2_score + 1)
      } else if(i > 2 && i <=4) {
        x = head_to_head(team2,team1)
         ifelse(x == "W",team2_score = team2_score + 1,team1_score = team1_score + 1)
      } else if (i == 5){
        x = head_to_head(team1,team2)
         ifelse( x == "W",team1_score = team1_score + 1,team2_score = team2_score + 1)
      } else if (i == 6) {
    ...
    paste0("Team 1: ", team1_score, ", Team 2: ", team2_score)
}
series("clippers","spurs")
