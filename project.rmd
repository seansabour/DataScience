...
>>>>>>> 0f898bf2969779fd421bbcd91c02f73d80a983a7
...
x = c()
series_BRUNZ1x13 = function(team1,team2) {
  team1_score = 0
  team2_score = 0
...
```{r}
set.seed(12)
series_BRUNZ1x13("clippers","blazers")
series_BRUNZ1x13("warriors","rockets")
series_BRUNZ1x13("thunder","mavericks")
series_BRUNZ1x13("spurs","grizzlies")

series_BRUNZ1x13("cavaliers","pistons")
series_BRUNZ1x13("hawks","celtics")
series_BRUNZ1x13("heat","hornets")
series_BRUNZ1x13("raptors","pacers")
...
set.seed(12)
series_BRUNZ1x13("warriors","blazers")
series_BRUNZ1x13("thunder","spurs")

series_BRUNZ1x13("cavaliers","hawks")
series_BRUNZ1x13("heat","raptors")
...
set.seed(12)
series_BRUNZ1x13("warriors","thunder")

series_BRUNZ1x13("cavaliers","raptors")
...
set.seed(12)
series_BRUNZ1x13("warriors","cavaliers")
