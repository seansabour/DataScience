...
x = predict(fit,newdaata = game_by_game15_16,type="response")
predicted = ifelse(x > 0.5,1,0)
...
team1_win_loss = head_to_head("spurs","cavaliers")

for(i in 1:7) {
  if(i <= 2){
    head_to_head(team1,team2)
  } else if(i > 2 && i <=4) {
    head_to_head(team2,team1)
  } else if (i == 5){
    head_to_head(team1,team2)
  } else if (i == 6) {
    head_to_head(team2,team1)
...
prec_rec1 = prec_recall_summary(predicted, actuals)
